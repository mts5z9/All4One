    ...
    <div class="row">
        <div class="col-md-12 ">
            <div class="panel panel-default">
                <div class="panel-heading">Edit Scanner</div>

                <div class="panel-body table-responsive">
                  <form class="form-horizontal" method="POST" action="/edit-scanner/{{$scanner->serialNum}}">
                      {{ csrf_field() }}
                      <div class="form-group{{ $errors->has('serialNum') ? ' has-error' : '' }}">
                          <label for="serialNum" class="col-md-4 control-label">Serial Number</label>
                          <div class="col-md-6">
                              <input id="serialNum" type="text" class="form-control" name="serialNum" value="{{$scanner->serialNum}}" required autofocus>
                      ...
                      <div class="form-group{{ $errors->has('pin') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="pin" type="text" class="form-control" name="pin" value="{{$scanner->pin}}" required autofocus>
                              @if ($errors->has('pin'))
                                  <span class="help-block">
                      ...
                      <div class="form-group{{ $errors->has('model') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="model" type="text" class="form-control" name="model" value="{{$scanner->model}}" required autofocus>
                              @if ($errors->has('model'))
                                  <span class="help-block">
