        ...
        <div class="col-md-12 ">
            <div class="panel panel-default">
                ...
                <div class="panel-body table-responsive">
                  <form class="form-horizontal" method="POST" action="/account-edit/{{$user->id}}">
                      {{ csrf_field() }}
                      ...
                      <div class="form-group{{ $errors->has('address2') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="address2" type="text" class="form-control" name="address2" value="{{$user->address2}}" autofocus>
