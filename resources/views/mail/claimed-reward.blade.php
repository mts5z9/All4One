            ...
            <div class="col-md-12 ">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      ...
                      <p>
                        You have claimed a reward from {{$reward['businessName']}}!
                      </p>
                    </div>
                    <div class="panel-body">
                      ...
                      <li>Cost: {{$reward['pointsSpent']}}</li>
                    </div>
                    <div class="panel-body">
                      <h4>You have {{$reward['pointsRemaining']}} points remaining to spend at {{$reward['businessName']}}</h4>
                    </div>
                  </div>
                </div>
            </div>
